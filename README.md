...
![Detailed systems blueprint for Excalidraw](assets/system-blueprint.png)
...
- **Architecture or flow brief**
- **Shape vocabulary**
- **Excalidraw scene graph**
- **Connector routing**
- **Editable JSON diagram**
...
This repository now includes a typed, task-adaptive harness contract for **Excalidraw**. The contract maps the skill to memory, planning, capability-orchestration, and action modules; defines bounded repair and stop behavior; and records skill-specific verification evidence.
