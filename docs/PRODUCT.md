...
Excalidraw is a focused, shareable agent workflow.

## What it does

Create hand-drawn Excalidraw JSON diagrams for architecture, flows, and sequences. Use when the user explicitly requests this capability or a closely related task.
